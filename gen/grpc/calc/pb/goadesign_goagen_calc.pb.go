...
var file_goadesign_goagen_calc_proto_rawDesc = []byte{
	...
	0x28, 0x01, 0x52, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x32, 0xdd, 0x01, 0x0a, 0x04, 0x43, 0x61,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x63, 0x61,
...
var file_goadesign_goagen_calc_proto_depIdxs = []int32{
	...
	2, // 1: calc.Calc.Add:input_type -> calc.AddRequest
	4, // 2: calc.Calc.Subtract:input_type -> calc.SubtractRequest
	6, // 3: calc.Calc.Divide:input_type -> calc.DivideRequest
	1, // 4: calc.Calc.Multiply:output_type -> calc.MultiplyResponse
	3, // 5: calc.Calc.Add:output_type -> calc.AddResponse
	5, // 6: calc.Calc.Subtract:output_type -> calc.SubtractResponse
